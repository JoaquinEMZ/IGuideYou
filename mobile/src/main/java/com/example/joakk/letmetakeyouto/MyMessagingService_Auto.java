...
public class MyMessagingService_Auto extends Service {
    public static final String READ_ACTION =
            "com.example.joakk.letmetakeyouto.ACTION_MESSAGE_READ";
    public static final String REPLY_ACTION =
            "com.example.joakk.letmetakeyouto.ACTION_MESSAGE_REPLY";
    public static final String CONVERSATION_ID = "conversation_id";
    public static final String EXTRA_VOICE_REPLY = "extra_voice_reply";
    private static final String TAG = MyMessagingService_Auto.class.getSimpleName();
